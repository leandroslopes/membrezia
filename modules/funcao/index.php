...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../public/js/scripts/jquery-dialog-form-funcao.js"></script>
    </head>
    <body>
        <div class="corpo">
            ...
            <div id="conteudo">
                ...
                <div class="modulo">
                    ...
                    <div class="oculto textoMedio" id="dialogCadastrarFuncao">
                        <br />
                        <form method="post" name="formCadastrarFuncao" id="formCadastrarFuncao" action="">
                            <input type="hidden" name="idModulo" id="idModulo" value="<?= $idModulo ?>"/>
                            <div class="negrito">
                                <label class="vermelho">*</label> <label>Sigla:</label> &nbsp;
                                <input type="text" name="sigla" id="sigla" maxlength="4" size="6" class="caixaAlta retiraAcento"/> 
                                <br /> <br />
                                <label class="vermelho">*</label> <label>Nome:</label> &nbsp;
                                <input type="text" name="nome" id="nome" maxlength="20" size="44" class="caixaAlta retiraAcento"/> 
                            </div>
                            <br />
                    ...
                    <div class="oculto textoMedio textoCentro" id="dialogExcluirFuncao">
                        <p>
                            Tem certeza que quer excluir esta função?
                        </p>
                    </div>

                    <div class="extrasConteudo">
                        <ul>
                            <li id="cadastrarFuncao">
                                <a class="cursor">
