        ...
        <div class="corpo">
            ...
            <div id="conteudo">
                ...
                <div class="modulo">
                    ...
                    <div class="oculto textoPequeno" id="dialogAdicionarOferta">
                        <br />
                        <form method="post" name="formAdicionarOferta" id="formAdicionarOferta" action="">
                            ...
                            <input type="hidden" name="tipoMovimentacao" id="tipoMovimentacao" 
                                   value="<?= MovimentacaoTipoUtil::OFERTA ?>"/>
                            <div class="negrito">
                                ...
                                <br /> <br />
                                <label class="vermelho">*</label> <label>Culto:</label> &nbsp;
                                <!--PREENCHER UM SELECT COM OS CULTO DA CONGREGACAO SELECIONADA--> 
                                <br /> <br />
                    ...
                    <div class="oculto textoPequeno" id="dialogExcluirOferta">
                        <p>
